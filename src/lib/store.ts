...
const DEFAULT_SETTINGS = { weightKg: 6.27, mlPerKgPerDay: 150, standardBottleVolume: 90, displayBottleVolumeWater: 90, yellowThresholdPct: 5, redThresholdPct: 10, timeFormat: '24h' as const, maxCorrectionPct: 25 };
